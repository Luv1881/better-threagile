...
|----------------------------------|--------------------------------|----------------------------------------------------------------------| ----------------------- |
| `Verbose`                        | bool                           | The same as `--verbose` at [flags](./flags.md)               | see [flags](./flags.md) |
...
| `InputFile`                      | string (path to file)          | The same as `--model` at [flags](./flags.md)                 | see [flags](./flags.md) |
| `RiskRulesPlugins`               | string (comma separated array) | The same as `--custom-risk-rules-plugin` at [flags](./flags.md)       | see [flags](./flags.md) |
| `SkipRiskRules`                  | string (comma separated array) | The same as `--skip-risk-rules` at [flags](./flags.md)       | see [flags](./flags.md) |
...
| `ReportLogoImagePath`         | string (path to file) | The same as `--reportLogoImagePath` at [flags](./flags.md) | see [flags](./flags.md) |
...
| `GraphvizDPI`                 | TBD                   | The same as `--verbose` at [flags](./flags.md)             | see [flags](./flags.md) |
| `MaxGraphvizDPI`              | TBD                   | The same as `--verbose` at [flags](./flags.md)             | see [flags](./flags.md) |
...
| Key                               | Type                  | Description                                                             | Default Values |
|-----------------------------------|-----------------------|------------------------------------------------------|------------------|
| `ReportConfiguration.HideChapter` | TBD                   | The same as `--verbose` at [flags](./flags.md)                                      | see [flags](./flags.md) |
...
| `ServerPort`               | int                        | The same as `--verbose` at [flags](./flags.md)                                            | see [flags](./flags.md) |
