...
type Risk struct {
	...
	Severity                        RiskSeverity               `yaml:"severity,omitempty" json:"severity"`
	ExploitationLikelihood          RiskExploitationLikelihood `yaml:"exploitation_likelihood,omitempty" json:"exploitation_likelihood"`
	ExploitationImpact              RiskExploitationImpact     `yaml:"exploitation_impact,omitempty" json:"exploitation_impact"`
